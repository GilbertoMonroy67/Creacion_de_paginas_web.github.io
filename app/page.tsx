...
const certificates = [
  ['Curso de Buenas Prácticas y Código Limpio en C#', 'C#, Clean Code, principios SOLID', 'Curso de Buenas Pr#U00e1cticas y C#U00f3digo Limpio en CSharp.jpg'],
  ...
  ['Manejo de datos, estructuras y funciones', 'Datos, estructuras y funciones', 'Curso de Pensamiento L#U00f3gico Manejo de Datos, Estructuras y Funciones.jpg'],
  ...
  ['Fundamentos de Ingeniería de Software', 'Ciclo de vida y fundamentos de software', 'Curso de Fundamentos de Ingenier#U00eda de Software.jpg'],
  ...
  ['Introducción a la Terminal y Línea de Comandos', 'Terminal, CLI y productividad', 'Curso de Introducci#U00f3n a la Terminal y L#U00ednea de Comandos.png'],
  ['Introducción a la Inteligencia Artificial', 'Conceptos y aplicaciones de IA', 'Curso Gratis de Introducci#U00f3n a la Inteligencia Artificial.png'],
  ['Introducción a Ciberseguridad', 'Prevención y fundamentos de seguridad', 'Curso de Introducci#U00f3n a Ciberseguridad_Prevenci#U00f3n de Ataques Inform#U00e1ticos.png'],
].map(([title, skill, image]) => ({ title, skill, image: `${certificateImages}${encodeURIComponent(image)}` }))
